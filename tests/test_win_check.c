...
{
    GameState gamestates[TEST_IS_GAME_FINISHED_VERTICAL_ARRAY_SIZE] = {{{'x', ' ', ' '},
                                                                        {'x', ' ', ' '},
                                                                        {'x', ' ', ' '}},
                                                                       {{' ', 'o', ' '},
                                                                        {' ', 'o', ' '},
...
{
    GameState gamestates[TEST_IS_GAME_FINISHED_HORIZONTAL_ARRAY_SIZE] = {{{'x', 'x', 'x'},
                                                                          {' ', ' ', ' '},
                                                                          {' ', ' ', ' '}},
                                                                         {{' ', ' ', ' '},
                                                                          {'o', 'o', 'o'},
...
{
    GameState gamestates[TEST_IS_GAME_FINISHED_DIAGONAL_ARRAY_SIZE] = {{{'x', ' ', 'x'},
                                                                        {' ', 'x', ' '},
                                                                        {' ', ' ', 'x'}},
                                                                       {{'o', ' ', ' '},
                                                                        {' ', 'o', 'o'},
...
{
    GameState gamestates[TEST_IS_GAME_FINISHED_ANTIDIAGONAL_ARRAY_SIZE] = {{{'x', ' ', 'x'},
                                                                            {' ', 'x', ' '},
                                                                            {'x', ' ', ' '}},
                                                                           {{'o', ' ', 'o'},
                                                                            {' ', 'o', 'o'},
